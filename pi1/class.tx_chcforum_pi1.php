	...
	class tx_chcforum_pi1 extends tslib_pibase {
		...
		*/
		function main($content, $conf) {
			...
			$fconf = t3lib_div::makeInstance("tx_chcforum_fconf",$this->cObj);
		...
		;
			...
			$gpvars['cat_uid'] = intval(t3lib_div::_GP('cat_uid'));
			$gpvars['conf_uid'] = intval(t3lib_div::_GP('conf_uid'));
			$gpvars['thread_uid'] = intval(t3lib_div::_GP('thread_uid'));
			$gpvars['post_uid'] = intval(t3lib_div::_GP('post_uid'));
			$gpvars['fe_user_uid'] = intval(t3lib_div::_GP('fe_user_uid'));
			$gpvars['page'] = intval(t3lib_div::_GP('page'));
			$gpvars['thread_endtime'] = intval(t3lib_div::_GP('thread_endtime'));
			$gpvars['rateSelect'] = intval(t3lib_div::_GP('rateSelect'));
			$gpvars['ratePostUID'] = intval(t3lib_div::_GP('ratePostUID'));
			...
			$profile_h = t3lib_div::_GP('profile_h');
			$profile_c = t3lib_div::_GP('profile_c');
			...
			if ($this->conf['postValidateMethod'] == 1) {
				...
				$gpvars['name'] = htmlspecialchars(t3lib_div::_GP('name'));
				$gpvars['subject'] = htmlspecialchars(t3lib_div::_GP('subject'));
				$gpvars['text'] = htmlspecialchars(t3lib_div::_GP('text'));			
			}
			
			$gpvars['attach_file_name'] = htmlspecialchars(t3lib_div::_GP('attach_file_name'));
