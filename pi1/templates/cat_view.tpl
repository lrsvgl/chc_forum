<!-- chc_forum Template cat_view.tpl -->
<div class="tx-chcforum-pi1-preTableWrap clearfix">
    {sub_tool_bar}
    {nav_path}
    {page_links_top}
</div>
<div class="table-responsive">
    <table class="table" summary="This table lists all categories and their respective conferences" class="tx-chcforum-pi1-Table">
